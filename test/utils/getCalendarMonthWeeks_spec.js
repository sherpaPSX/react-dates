...
describe("getCalendarMonthWeeks", () => {
  describe("input validation", () => {
    it("throws a TypeError if first arg is not a valid dayjs object", () => {
      const invalidValues = [
        null,
      ...
      invalidValues.forEach((value) => {
        expect(() => getCalendarMonthWeeks(value)).to.throw(
          TypeError,
          "`month` must be a valid dayjs object"
        );
      });
    });
  ...
  it("all days have a time of 12PM", () => {
    weeks.forEach((week) => {
      week.forEach((day) => {
        if (day) {
          expect(day.set("hour")).to.equal(12);
        }
      });
    });
  });
  ...
  describe("padding when enableOutsideDays is false", () => {
    ...
    beforeEach(() => {
      ...
      weeksWithPadding = getCalendarMonthWeeks(dayjs("2017-02-01"), false);
    });
  ...
  describe("enableOutsideDays arg is true", () => {
    ...
    it("last week contains last of the month if next month begins on Sunday", () => {
      const december2016 = dayjs("2016-12-01");
    ...
    it("last week contains last of the month if next month begins on Monday", () => {
      dayjs.locale("es");
      const april2017 = dayjs("2017-04-01");
    ...
    it("last week contains last of the month if next month begins on Saturday", () => {
      const september2016 = dayjs("2016-09-01");
  ...
  describe("setting firstDayOfWeek argument", () => {
    ...
    const january2017Start = dayjs("2017-01-01"); // Sunday
